...
// @include		https://flasktools.altervista.org/*
...
var LANG = {
    ...
    $('<script src="https://flasktools.altervista.org/downloads/Flask-tools-version.user.js"></script>').appendTo("head");
        ...
        if (version_text === '') {
                    if (version < latest_version) {
                        version_text = "<div class='version_icon red'></div><div class='version_text'>" + getText('settings', 'version_old') + "</div><div class='version_icon red'></div>" +
                            "<a class='version_text' href='https://flasktools.altervista.org/downloads/FLASK-TOOLS.user.js' target='_top'>-->" + getText('settings', 'version_update') + "</a>";
        ...
        $("#flask_tools").click(function () {
            ...
            if (!$('#flask_settings').get(0)) {
                ...
                $('<style id="flask_settings_style">' +
                    ...
                    '#flask_settings #version_info { font-weight:bold;height: 35px;margin-top:-5px; } ' +
                    ...
                    '#flask_settings .content { border:2px solid darkgreen; border-radius:5px; border-top-left-radius:0px; background:rgba(31, 25, 12, 0.1); top:23px; position:relative; padding:10px; height:350px; overflow-y:auto; } ' +
                ...
                $('.settings-container').append(
                    ...
                    '<div class="game_header bold"><a href="#" target="_blank" style="color:white">FLASK-Tools (v' + version + ')</a></div>' +

                        // Check latest version
                    '<div id="version_info"><img src="https://666kb.com/i/csmicltyu4zhiwo5b.gif" /></div>' +

                        // Donate button
                    '<div style="position:absolute; left: 495px;top: 30px;"><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=flasktools%40gmail.com&currency_code=EUR&source=url" target="_blank">' +
    ...
    // Compatibility with Dio-David
    $('<style id="flask_dio_compatibility"> #ui_box .btn_settings.dio_settings {top: 116px !important; right: 103px !important;} </style>').appendTo('head');
    ...
    var UnitComparison = {
        ...
        openWindow: function () {
            var content =
                // Title tabs
                '<ul id="flask_comparison_menu" class="menu_inner" style="top: -36px; right: 35px;">' +
    ...
    function setResWW(stage, ww_type, ww_share, wndID) {
        try {
            ...
            $(wndID + '.ww_ratio').append(
                ...
                '<div class="wonder_for_player" style="margin-left: 130px; font-size:16px;">' + ' <span style="color:#090">' + (Math.round(wonder.ratio[AID] * 100) / 100) + '%</span>' +
                '</div>');
    ...
    var Duration = {
        activate: function () {
            ...
            $('<style id="flask_short_duration_style">' +
                ...
                '.town_info_duration_pos { position: absolute; } ' +
                ...
                '.attack_support_window .max_booty { padding:0px 0px 0px 30px; margin:3px 4px 4px 4px; width:auto;  position: absolute; left: 245px; top: 28px; } ' +
                '.attack_support_window .fight_bonus.morale { margin-top:2px; position: relative; left: 330px; top: 26px; } ' +
                ...
                '.attack_support_window .send_units_form .attack_type_wrapper .attack_table_box { text-align:left;  transform:scale(0.8); position: relative; top: 55px; margin-left: -60px;}' +
                ...
                '.tab_type_support #btn_plan_attack_town { position: relative; top:73px; right:18px; }' +
                '.tab_type_attack #btn_plan_attack_town { position: relative; right:15px; }' +
                '.attack_support_window .tab_type_support #btn_runtime { position: relative; top:73px; right: 18px; }' +
                '.attack_support_window .tab_type_attack #btn_runtime { position: relative; right:15px; }' +
                '.attack_support_window .send_units_form .button_wrapper .button { position: relative; top:74px; right:18px; }' +
                '.attack_support_window .send_units_form .breaker { bottom:-5px; }' +
    ...
    var RecruitingTrade = {
        activate: function () {
            $('<style id="flask_style_recruiting_trade" type="text/css">' +
                ...
                '#flask_recruiting_trade { position:absolute; left:30px; top:70px; } ' +
    ...
    var Simulator = {
        activate: function () {
            $('<style id="flask_simulator_style" type="text/css">' +
                ...
                '#place_simulator .place_sim_heroes_container .place_simulator_table { height: 64px!important; position: relative; bottom: 3px; } '+
                    ...
                    for (var f in smileyArray[e]) {
                        if (smileyArray[e].hasOwnProperty(f)) {
                            ...
                            if (src.substring(0, 2) == "i/") {
                                smileyArray[e][f].src = "https://666kb.com/" + src + ".gif";
                            } else {
   ...
   /*******************************************************************************************************************************
     ...
     *******************************************************************************************************************************/
     var FavorPopup = {
        ...
        godImg: {
            zeus:'background-position: -248px 0px;',
            hera:'background-position: -186px -62px;',
            poseidon:'background-position: -124px -186px;',
            athena:'background-position: 0px -124px;',
            hades:'background-position: -124px -124px;',
            artemis:'background-position: -124px 0px;',
            aphrodite:'background-position: 0px 0px;',
            ares:'background-position: 0px -62px;',
        },

        activate: function () {
            $('.favor_amount, .favor_amount max').bind('mouseover mouseout', function () {
                return false;
            });
            $('.gods_favor_button_area').bind('mouseover', function () {
                FavorPopup.setFavorPopup();
            });
        },

        deactivate: function () {
            $('.favor_amount, .favor_amount max').unbind('mouseover mouseout');
            $('.gods_favor_button_area').unbind('mouseover');
        },
        ...
        setFavorPopup: function () {
            ...
            for (var g in FavorPopup.godArray) {
                if (FavorPopup.godArray.hasOwnProperty(g)) {
                    if (uw.ITowns.player_gods.attributes.temples_for_gods[g]) {
                        pic_row += '<td><div style="background: url(https://gpit.innogamescdn.com/images/game/autogenerated/gods/gods_default_62x62_f4a3cc7.png); transform:scale(0.9); margin: -3px;' + FavorPopup.godImg[g] + '"; class="gods_container god_mini ' + FavorPopup.godArray[g] + '";></td>';
            ...
            $('.favor_amount, .favor_amount max').tooltip(tooltip_str);
        }
    };
    ...
    var ActivityBoxes = {
        activate: function () {
            ...
            $('<style id="fix_lists" type="text/css">' +
                ...
                '</style>' +
                '<style id="flask_fix_trade" type="text/css">' +
        ...
        showTradeList: function () {
            if (!$('#flask_trades_activity_style').get(0)) {
                $('#toolbar_activity_trades').mouseover();
                $('<style id="flask_trades_activity_style"> #toolbar_activity_trades_list { display: block !important; } </style>').appendTo("head");
            }
        },
        showCommandList: function () {
            if (!$('#flask_commands_activity_style').get(0)) {
                $('#toolbar_activity_commands').mouseover();
                $('<style id="flask_commands_activity_style"> #toolbar_activity_commands_list { ' +
        ...
        hideTradeList: function () {
            if ($('#flask_trades_activity_style').get(0)) {
                $('#flask_trades_activity_style').remove();
                $('#toolbar_activity_trades').mouseout();
            }
        },
        hideCommandList: function () {
            if ($('#flask_commands_activity_style').get(0)) {
                $('#flask_commands_activity_style').remove();
                $('#toolbar_activity_commands').mouseout();
            }
        },
        activate2: function () {
        ...
        NewYear : {
            add : function(){
                ...
                $('<a href="http://www.greensmilies.com/smilie-album/" target="_blank"><div id="flask_newYear">'+
                    ...
                    '<img src="https://flasktools.altervista.org/images/smileys/sign2_2.gif">'+
                    '<img src="https://flasktools.altervista.org/images/smileys/sign2_1.gif">'+
    ...
    var CultureOverview = {
        ...
        activate: function () {
            {setTimeout(function () {CultureOverview.activate();}, 0);}
			...
			if (h.indexOf("[") < 1) {
				...
				if (k > 0) {
					$("#culture_points_overview_bottom #place_culture_count").append("<span id='flaskculture'>[-" + k + "]</span>");
				} else {
					var l = new Array;
			...
			if ($('#flask_cultureBTN_wrapper').length == 0) {
				$("#culture_overview_wrapper").parent().append('<div id="flask_cultureBTN_wrapper"><div class="flask_cultureBTN_wrapper_right"><div id="flask_cultureBTN_theather_r" class="flask_cultureBTN_r flask_cultureBTN_theather"></div><div id="flask_cultureBTN_triumph_r" class="flask_cultureBTN_r flask_cultureBTN_triumph"></div><div id="flask_cultureBTN_olympicgames_r" class="flask_cultureBTN_r flask_cultureBTN_olympicgames"></div><div id="flask_cultureBTN_cityfestival_r" class="flask_cultureBTN_r flask_cultureBTN_cityfestival"></div></div></div>');
				...
				$(".flask_cultureBTN_l, .flask_cultureBTN_r").css({
					...
					"background" : "url(https://flasktools.altervista.org/images/game/lztu5tha.png)"
				});
            ...
            try {
                ...
                flask.wnd.find("#trade_tab").append(
				    ...
				    '<a id="dio_stone_'+dio.wndId+'_cultreverse" class="dio_trade dio_send_cult_reverse" style="top:234px"></a>' +
			     	'<a id="dio_iron_'+dio.wndId+'_cultreverse" class="dio_trade dio_send_cult_reverse" style="top:268px"></a>'*/
				    /*'</div>'
                );
                ...
                flask.wnd.find(".flask_send_cult").css({
                    ...
                    "height" : "16px",
                    "width" : "22px",
                    "background-image" : "url(https://flasktools.altervista.org/images/game/trade-cult.png)",
                    "background-repeat" : "no-repeat",
                    "background-position" : "0px -1px"
                });
                flask.wnd.find(".flask_send_cult_reverse").css({
                    "left" : "105px",
                    "position" : "absolute",
                    "height" : "16px",
                    "width" : "22px",
                ...
                flask.wnd.find(".flask_max").css({
                    ...
                    "height" : "16px",
                    "width" : "22px",
                    "background-image" : "url(https://flasktools.altervista.org/images/game/trade-arrow.png)",
                    "background-repeat" : "no-repeat",
                    "background-position" : "0px -1px"
                });
                ...
                // Tooltip
                $('.flask_max').tooltip(flask_icon + "max");
                $('.flask_send_cult').tooltip(flask_icon + getText("culure", "cityfestivals"));
